...
- **Personal Shopper** — save the stores and brands you love, and an AI shopper (which searches the live web) suggests new pieces that fill gaps in your closet, checks your saved stores for current sales, and discovers new brands you can save with one tap. Brands are added automatically from new piece photos, and **Scan closet for brands** finds them in pieces you've already added (needs an API key — see Setup).
