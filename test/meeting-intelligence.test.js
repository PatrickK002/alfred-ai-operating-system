...
test("agent reviews route meeting context to Alfred, Sarah, Olivia, Westbridge, Ethan and Sentinel", () => {
  withDatabase((db) => {
    const detail = createMeetingRecord(db, {
      ...westminsterMeeting({
        id: "calendar-agent-routing-1",
        bodyPreview: "BIM, invoice, property due diligence, platform architecture and confidential access review.",
      }),
      transcriptText: transcriptText(),
